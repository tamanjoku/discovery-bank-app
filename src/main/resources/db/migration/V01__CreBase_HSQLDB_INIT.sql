...
CREATE TABLE DENOMINATION (
  DENOMINATION_ID        INTEGER NOT NULL IDENTITY,
...
CREATE TABLE CLIENT_ACCOUNT (
  CLIENT_ACCOUNT_NUMBER VARCHAR(10),
...
CREATE TABLE CREDIT_CARD_LIMIT (
  CLIENT_ACCOUNT_NUMBER VARCHAR(10)    NOT NULL REFERENCES CLIENT_ACCOUNT (CLIENT_ACCOUNT_NUMBER),
...
CREATE TABLE ATM_ALLOCATION (
  ATM_ALLOCATION_ID INTEGER IDENTITY,
